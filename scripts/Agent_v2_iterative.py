        ...
        for idx, child in enumerate(node.children):
            ...
            if not accumulated_prob:
                ...
                for i in range(len(accumulated_prob)):
                    #TODO: add a checker. first check if 
...
with open("/Users/ruoxiliu/Desktop/Argo_research/reasoning/sense/backtracking/temp.txt", "r") as f:
    ...
    for line in lines:
        log_file = "./test_trail_free_3.txt"
        max_step = 50
        agent = AgentS1("/Users/ruoxiliu/Desktop/Argo_research/reasoning/sense/backtracking/2.json", line, log_file)
